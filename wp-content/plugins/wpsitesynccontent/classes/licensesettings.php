...
SyncDebug::log(__METHOD__.'() values=' . SyncDebug::arr_sanitize($values));
//SyncDebug::log(' - post=' . SyncDebug::arr_sanitize($_POST));
		$input = $this->post('spectrom_sync_settings', array());
//SyncDebug::log(' - input=' . SyncDebug::arr_sanitize($input));
